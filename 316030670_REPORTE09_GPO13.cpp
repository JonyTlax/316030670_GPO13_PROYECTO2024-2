//Reporte 8 - Tlaxcoapan Reyna - Gpo 13 - Semestre 2024-2
#include <iostream>
#include <cmath>
...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Reporte 8 - Tlaxcoapan Reyna - Gpo 13", nullptr, nullptr);
	...
	Model Estructura((char*)"Models/Estructura/Estructura1.obj");

	Model Palmera((char*)"Models/Palmera/palmera.obj");
	Model Librero((char*)"Models/Librero/librero.obj");
	Model Atril((char*)"Models/Pulpitos/atril.obj");
	Model Banca((char*)"Models/Banca/banca.obj");
	Model SmartTv((char*)"Models/SmartTv2/smartv.obj");
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		//---------------------------PENDIENTE HASTA LA REVISION DEL MAPEO UV------------------
		//model = glm::mat4(1);
